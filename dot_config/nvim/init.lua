  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        --   ↓ reportAbstractUsage                  default: "error"
        -- pylsp = {},
        -- rust_analyzer = {},
        -- jinja_lsp = { filetypes = { 'html', 'jinja' } },
        ...
        dependencies = {
          ...
          --    https://github.com/rafamadriz/friendly-snippets
          {
            ...
            config = function()
              ...
              require('luasnip').filetype_extend('htmljinja', { 'html' })
...
cmp.setup {
  mapping = {
    ['<Tab>'] = cmp.mapping.confirm { select = true },
    ['<CR>'] = cmp.mapping.confirm { select = true },
    -- You can also configure other keys, like <Tab>, as needed.
  },
  -- Other nvim-cmp configurations go here.
}
...
require('lualine').setup {
  ...
  sections = {
    ...
    lualine_c = {
      ...
      {
        'buffers',
        symbols = { modified = ' ●' }, -- Optional: Shows modified indicator
        mode = 2, -- Mode 2 displays buffer numbers
        max_length = vim.o.columns * 2 / 3,
        buffers_color = {
          active = { fg = '#ff9e64', bg = '#1e1e2e', gui = 'bold' }, -- Active buffer color
          inactive = { fg = '#a9a9a9', bg = '#282c34' }, -- Inactive buffer color
        },
      },
    },
    lualine_x = {
    ...
    lualine_y = { 'encoding', 'fancy_searchcount' },
    lualine_z = { 'location' },
  },
  inactive_sections = {
    lualine_a = {},
...
--
vim.cmd [[
  let g:find_last_char = ''
  let g:find_last_backward = 0

  fun! Find(char, backward)
    let g:find_last_char = a:char
    let g:find_last_backward = a:backward
  ...
  fun! RepeatFind(reverse)
    if g:find_last_char != ''
      call Find(g:find_last_char, a:reverse ? !g:find_last_backward : g:find_last_backward)
    endif
  endfun
...
-- disable s and S to replace a character (this is probably one of the most useless things in nvim)
...
vim.filetype.add {
  extension = {
    html = 'htmldjango', -- force .html files to be treated as Jinja
    jinja = 'htmldjango',
    jinja2 = 'jinja',
    j2 = 'jinja',
  },
...
vim.keymap.set('n', '<leader>yf', function()
  ...
  print('Filename yanked to clipboard: ' .. filename)
